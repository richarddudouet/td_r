...
Les bases de données se trouve à cette adresse github.com.richardudouet/tdr/TD1/Data

Pour importer, vous pouvez cliquer sur *Import Dataset* dans la fenêtre en haut à droite: Environment.\
...
library(tidyverse)
load("C:/Users/richa/Desktop/Travail/4. Enseignement/td_r/TD1/z.Enseignant/envtd1.RData")
```
